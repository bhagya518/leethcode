...
Hi, I'm Bhagya, a Computer Science student passionate about problem solving and software development.

This repository documents my daily LeetCode practice and DSA preparation journey. My goal is to build strong problem-solving skills and prepare for software engineering interviews.

## 📊 Current Goal
- Complete Striver's A-Z DSA Sheet
- Apna college DSA Sheet
- Strengthen competitive programming and interview skills

## 🛠️ Primary Language
- C++

## 📚 Topics
Arrays • Strings • Linked Lists • Trees • Graphs • Dynamic Programming • Greedy • Backtracking • Binary Search • Heaps • Tries

## 🎯 Why This Repository?

- Track daily consistency
- Document learning progress
- Build an interview-ready DSA portfolio
